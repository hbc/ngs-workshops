...
This first session will familiarize you with the system, and we will be using the same principles during the various sequencing modules of the workshops. We’ll see how to access Galaxy from your machine, get oriented and perform some basic tasks. Because genomic data is usually very large and the bioinformatics tools which we use tend to take a very long time to execute, it is a good idea to be running the data analysis on a dedicated computer system as opposed to on your own laptop or machine. This is why in this tutorial series we will be using Galaxy running on a remote machine (“in the Cloud” using [Amazon's EC2 environment](http://aws.amazon.com/ec2/)) which has been set up for you. This environment on the Cloud will be accessible to you for the duration of this course. We will be providing instructions towards the end of the course on how to set up your own system using [CloudMan](http://usecloudman.org/) and get Galaxy running once this course is over.
...
> If you want to work through this session outside of this course, take a look at our section on [how to set up your own Galaxy server](/posts/running-your-own-galaxy-instance/) or download the [complete introduction dataset](https://dl.dropbox.com/u/407047/Blog/Data/Galaxy_Introduction_files.tgz) and use one of the public Galaxy instances.
...
You should always remember **to log in to Galaxy** by clicking on the `User` menu item and `Log in` with your email address and password. If you are not already registered, take a moment to do so now. Click on the `User` menu item and `Register`  by filling out your email address, preferred password and a public name (all lowercase) by which you’d like to be identified to other users. Click `Submit` and Galaxy will automatically log you in to your new account. Even though it is not required to run analyses, logging in with your account gives you much more power and functionality when it comes to managing histories and workflows. We’ll see this later on. Now that we’ve seen what the various panes do, let’s explore Galaxy with an actual analysis!
...
[![Explore the results](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyImportResults.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyImportResults.png)

Next to the “eye” button is a little “pencil” button [^2]. If you click on that, you can edit the attributes of this dataset:

[![Editing data attributes](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyEdits.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyEdits.png)
...
1. **[DOWNLOAD THIS](https://dl.dropbox.com/u/407047/Blog/Data/ucsc_hg18_chrX.bed.txt)** file from our servers -- it contains the same information as the gene list you retrieved from the data library, but is limited to genes located on the X chromosome. 
2. Take note of the download location
...
[![Data upload](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUpload.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUpload.png)
...
[![Data upload results](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUploadResults.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUploadResults.png)
...
**Move on to [Data manipulation](http://scriptogr.am/ohofmann/post/data-manipulation).**
...
[![Cutting columns](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyCutColumns.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyCutColumns.png)
...
**It is always a good idea to rename your datasets as they are created to make sure you can recognize it. It’s very easy to get lost in many hundreds of data steps and datasets in Galaxy when performing complicated analyses!** 
...
[![Converting formats](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyFormatConversion.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyFormatConversion.png)
...
[![Filter genes by exon count](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyFilter.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyFilter.png)
...
Now that we've got our list of short genes on the X chromosome and their locations, lets pull in a list of SNPs and their locations.

## Data integration

In this step, we will import a list of SNPs and their locations, and then join this dataset with our short genes on the X-chromosome dataset. For this, we first need to import the [SNPs](http://en.wikipedia.org/wiki/Single-nucleotide_polymorphism) dataset. Let's use the most up to date SNP build for our genome build (hg18), [SNP build 130](http://www.ncbi.nlm.nih.gov/SNP/snp_summary.cgi?view+summary=view+summary&build_id=130).
...
[![Aquiring list of SNPs from UCSC](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCTables.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCTables.png)

Finally, on the next page, leave all the options at their default settings and click on the `Send query to Galaxy` button. 

[![Executing an UCSC query](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCSend.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCSend.png)
...
[![UCSC import in History Panel](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCHistory.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyUCSCHistory.png)
...
[![Get flanking regions](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyGetFlanks.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyGetFlanks.png)
...
[![Joined data sets](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyJoin.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyJoin.png)
...
[![Join results](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyJoinResults.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyJoinResults.png)
...
[![Display in UCSC Main](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyDisplayInUCSC.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyDisplayInUCSC.png)
...
[![UCSC View](https://dl.dropbox.com/u/407047/Blog/Screenshots/UCSCView.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/UCSCView.png)
...
[![Custom view](https://dl.dropbox.com/u/407047/Blog/Screenshots/UCSCCustomTracks.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/UCSCCustomTracks.png)
...
[![Naming histories](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyNaming.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyNaming.png)
...
[![Tags](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyTags.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyTags.png)
...
[![Storing histories](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyHistories.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyHistories.png)
This should bring you to a list that looks like this: 

[![History view](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyHistoryList.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyHistoryList.png)
...
[![Publishing histories](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyShare.png)](https://dl.dropbox.com/u/407047/Blog/Screenshots/GalaxyShare.png)
...
You are done with the introduction! Move on to any of the other sequencing-related modules, take a look at the optional [exercises](http://scriptogr.am/ohofmann/post/galaxy-exercises) or [let us know](http://scriptogr.am/ohofmann/about) if you have more questions.
...
* Download exon data for human chromosome 18 from the latest _hg19_ build from the UCSC table browser in BED format[^1]. 
* Download single nucleotide polymorphism (SNP) data for the same chromosome and same build from the same source in the same format[^2]. Remember to rename your datasets!
...
> What does this new dataset tell you? How many SNPs are there _on exons_ on chromosome 18? Is this value different from the number of exons or the number of SNPs we saw before? Why?[^3] 
...
* Rejoin this last dataset with our original exon dataset so that we now have a more complete exon dataset which also has counts of SNPs for each exon ID entry[^4]. 
* Visualize this last dataset in the UCSC Genome Browser. Select one of the exons that Galaxy just submitted to UCSC genome browser and zoom in to see the SNPs in that exon[^5]. 

[^1]: You should first select to download UCSC genes as before, but there will be additional options to limit your download to only exons. 
[^2]: Look under the `Variation and Repeats` group. Select `Common SNPs (132)`.
[^3]: Do any of the exon IDs in the joined dataset occur more than once? 
[^4]: Use the `Join` tool and join by exon ID. Remember to place the dataset with the ordered count values first (on the left) when performing the join. Remember that ordering is important when joining datasets. 
[^5]: Make sure that you have the correct SNP dataset that you chose in the beginning displayed in the UCSC genome browser. Default settings may not be appropriate. 